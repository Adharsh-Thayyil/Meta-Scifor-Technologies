...
SECRET_KEY = 'django-insecure-yxnz9*#fbqwc^stm4e(s!%=yao#(sck#=$95a&!#zkx5(my@z='
...
JAZZMIN_SETTINGS = {
    'site_header': "Cloud9",
    'site_brand': "Elevate Your Stay at Cloud9.",
    'site_logo': "/images/logo-admin.png",
    'copyright':  "All Right Reserved 2024",
    "welcome_sign": "Welcome to Cloud9, Login Now.",
    "topmenu_links": [

        {"name": "Home",  "url": "admin:index", "permissions": ["auth.view_user"]},
        {"name": "Hotels", "url": "/admin/hotel/"},
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'thayyiladharsh@gmail.com'
EMAIL_HOST_PASSWORD = 'xekczhpmstmwasmr'
DEFAULT_FROM_EMAIL = 'cloud9@gmail.com'
